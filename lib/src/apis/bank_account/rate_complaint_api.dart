...
class RateComplaintApi extends BaseApi {
  String url = CoreConfig.getApiUrl() + '/rekening/pengaduan/rate';

  Future<ResultApi> request({required int accountId, required int complaintId, required int complaintRate}) async {
    url += '/$accountId/$complaintId';
